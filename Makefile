...
SOURCES = \
	__init__.py \
	automated_culvert_analysis_workflow.py automated_culvert_analysis_workflow_dialog.py

	
PLUGINNAME = automated_culvert_analysis_workflow

PY_FILES = \
	__init__.py \
	automated_culvert_analysis_workflow.py automated_culvert_analysis_workflow_dialog.py

UI_FILES = dialog_base.ui
...
QGISDIR=C:\Users\aspra\AppData/Roaming/QGIS/QGIS3/profiles/default/python/plugins
